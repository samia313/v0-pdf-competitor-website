...
export const LOCAL_PAYMENT_METHODS: LocalPaymentMethod[] = [
  {
    ...
    steps: [
      ...
      'Enter receiver number: 03450100172',
  ...
  {
    id: 'bank_transfer',
    name: 'Bank Transfer (Faysal)',
    icon: '🏦',
    number: 'PK83FAYS3667786000002590',
    title: 'Naveed Ahmad Sharif',
    instructions: 'Direct bank transfer for maximum security and detailed transaction records',
...
export const PAYMENT_METHODS = [
  ...
  },
  {
    ...
    processingTime: 'Instant',
    fees: 'Included',
    description: 'PayPal balance or linked card - Global',
    recommended: false,
  },
