            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="prose prose-neutral dark:prose-invert max-w-none text-muted-foreground">
                <p className="text-lg leading-relaxed mb-4">
                  pdfilio was born from a simple frustration: why should basic PDF operations 
                ...
                <p className="text-lg leading-relaxed">
                  Today, pdfilio serves over a million users monthly from 190+ countries. 
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Join millions of users who trust pdfilio for their document needs. 
