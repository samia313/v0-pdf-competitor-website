...
import { BookOpen, Loader2, Download, Sparkles, FileText } from 'lucide-react'
...
export default function AIStudyNotesGeneratorPage() {
      ...
      <div className="w-full min-h-screen bg-background flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center">
          <Card className="p-8 max-w-md text-center">
            ...
            <p className="text-muted-foreground mb-6">Upgrade to access Study Notes Generator and convert PDFs into comprehensive study materials.</p>
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      formData.append('featureType', 'studynotes')
      ...
      if (!response.ok) throw new Error('Failed to generate study notes')
    ...
    <div className="w-full min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 container max-w-4xl mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold mb-2">AI Study Notes Generator</h1>
            <p className="text-muted-foreground">Convert PDF documents into comprehensive study notes</p>
          </div>
          ...
          {result && (
            <Card className="p-8">
              <div className="flex justify-between items-center mb-6">
                ...
                <Button variant="outline" onClick={downloadNotes}><Download className="w-4 h-4 mr-2" />Download</Button>
              </div>
