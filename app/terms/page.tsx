...
export const metadata = {
  ...
  description: 'Read the terms of service for using PDFMaster PDF tools.',
}
      ...
      <main className="flex-1 py-12">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none">
            ...
            <p>
              By accessing and using PDFMaster, you agree to be bound by these Terms of Service.
              If you do not agree to these terms, please do not use our services.
            </p>

            <h2>Description of Service</h2>
            <p>
              PDFMaster provides free online PDF tools including but not limited to:
            </p>
            <ul>
            ...
            <p>
              ...
              ownership of your content. The PDFMaster website, logo, and tools are protected
              by intellectual property laws.
            </p>

            <h2>Disclaimer of Warranties</h2>
            <p>
              PDFMaster is provided &quot;as is&quot; without warranties of any kind. We do not guarantee:
            </p>
            <ul>
            ...
            <p>
              To the maximum extent permitted by law, PDFMaster shall not be liable for any
            ...
            <h2>Advertising</h2>
            <p>
              Our free service is supported by advertising. By using PDFMaster, you consent
