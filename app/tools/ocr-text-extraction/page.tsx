...
import { FileText, Loader2, Copy, Download, Sparkles, Scan } from 'lucide-react'
...
export default function OCRTextExtractionPage() {
      ...
      <div className="w-full min-h-screen bg-background flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center">
          <Card className="p-8 max-w-md text-center">
            ...
            <p className="text-muted-foreground mb-6">Upgrade to access OCR Text Extraction and extract text from scanned documents.</p>
  ...
  const handleExtract = async () => {
    ...
    try {
      ...
      formData.append('featureType', 'extract')
      ...
      while (true) {
        ...
        if (done) break
        extracted += new TextDecoder().decode(value)
      }
      ...
      <main className="flex-1 container max-w-4xl mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">Extract text from scanned PDFs and images using advanced OCR technology</p>
          </div>
          ...
          <Card className="p-8 mb-8">
            ...
            >
              ...
              <p className="text-lg font-medium mb-2">Click to upload scanned PDF</p>
            ...
            {uploadedFile && (
              <div className="mt-6 p-4 bg-green-50 rounded-lg">
                ...
                <p className="text-sm text-green-700">Ready to extract text</p>
              </div>
            )}
          </Card>
            ...
            <Card className="p-8">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex gap-2">
                  ...
                  <Button variant="outline" size="sm" onClick={downloadExtracted}>
